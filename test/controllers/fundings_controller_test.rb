...
class FundingsControllerTest < ActionController::TestCase
  ...
  test "should create funding" do
    assert_difference('Funding.count') do
      post :create, funding: { amount: @funding.amount, approved: @funding.approved, percentage: @funding.percentage }
    end
  ...
  test "should update funding" do
    patch :update, id: @funding, funding: { amount: @funding.amount, approved: @funding.approved, percentage: @funding.percentage }
    assert_redirected_to funding_path(assigns(:funding))
  end
